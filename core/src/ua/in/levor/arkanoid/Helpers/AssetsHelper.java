...
public class AssetsHelper {
    ...
    public static final String POWER_UP_STEEL_BALL = "PowerUps/steel_ball.png";
    public static final String POWER_UP_FIRE_BALL = "PowerUps/fireball.png";
    public static final String POWER_UP_MAGNET = "PowerUps/magnet.png";
